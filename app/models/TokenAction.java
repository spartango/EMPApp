...
@Entity public class TokenAction extends Model {

    public enum Type {
        @EnumValue("EV") EMAIL_VERIFICATION,

        @EnumValue("PR") PASSWORD_RESET
    }
    ...
    @ManyToOne public User                                         targetUser;

    public Type                                                    type;

    @Formats.DateTime(pattern = "yyyy-MM-dd HH:mm:ss") public Date created;

    @Formats.DateTime(pattern = "yyyy-MM-dd HH:mm:ss") public Date expires;
    ...
    public static void deleteByUser(final User u, final Type type) {
        Ebean.delete(find.where()
                         .eq("targetUser.id", u.id)
                         .eq("type", type)
                         .findIterate());
    }
    ...
    public static TokenAction create(final Type type,
                                     final String token,
