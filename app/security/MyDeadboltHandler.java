...
public class MyDeadboltHandler extends AbstractDeadboltHandler {
    ...
    @Override public Result beforeRoleCheck(final Http.Context context) {
        if (PlayAuthenticate.isLoggedIn(context.session())) {
            ...
            context.flash().put("error",
                                "You need to log in first, to view '"
                                        + originalUrl
                                        + "'");
    ...
    @Override public RoleHolder getRoleHolder(final Http.Context context) {
        final AuthUserIdentity u = PlayAuthenticate.getUser(context);
        // Caching might be a good idea here
        return User.findByAuthUserIdentity(u);
    }

    @Override public DynamicResourceHandler
            getDynamicResourceHandler(final Http.Context context) {
        return null;
    }

    @Override public Result onAccessFailure(final Http.Context context,
