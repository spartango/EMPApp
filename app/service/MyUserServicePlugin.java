...
public class MyUserServicePlugin extends UserServicePlugin {
    ...
    @Override public Object save(final AuthUser authUser) {
    ...
    @Override public Object getLocalIdentity(final AuthUserIdentity identity) {
    ...
    @Override public AuthUser merge(final AuthUser newUser,
    ...
    @Override public AuthUser link(final AuthUser oldUser,
